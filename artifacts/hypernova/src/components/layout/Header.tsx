                        ...
                        <div className="p-2 space-y-1">
                          {searchResults.map((article) => (
                            <Link key={article.id} href={`/article/${article.slug}`}>
                              <div className="block p-2 hover:bg-muted rounded-md transition-colors cursor-pointer">
                                <div className="flex items-center justify-between mb-1">
                                  <Badge variant="secondary" className="text-[10px] py-0">{article.category}</Badge>
                                </div>
                                <h4 className="text-sm font-medium text-foreground line-clamp-1">{article.title}</h4>
                              </div>
                            </Link>
                          ))}
                        </div>
        ...
        <div className="fixed inset-0 z-50 bg-background md:hidden flex flex-col animate-in slide-in-from-right-full duration-300">
          <div className="flex items-center justify-between p-4 border-b">
            <div className="flex flex-col">
              ...
              <span className="text-[10px] font-semibold uppercase tracking-widest text-muted-foreground">Learning Institute</span>
            </div>
